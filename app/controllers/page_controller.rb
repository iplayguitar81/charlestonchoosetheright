class PageController < ApplicationController
  ...
  def calendar
    @season15_16 = GameRecap.where("datey BETWEEN '2015-10-20T00:00:00-00:00' AND '2018-06-30T00:00:00-00:00' ").order("datey DESC")
  ...
  def contact_us
    ...
    def contact_us2
      ...
      admin.each do |user|
        ...
        UserMailer.contact_us(user.email,params[:name],params[:email],params[:phone],params[:contact],params[:question],params[:newsletter],params[:song]).deliver
