...
class HighlightsControllerTest < ActionController::TestCase
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post :create, highlight: { caption: @highlight.caption, date: @highlight.date, image: @highlight.image, title: @highlight.title }
    end
  ...
  test "should update highlight" do
    patch :update, id: @highlight, highlight: { caption: @highlight.caption, date: @highlight.date, image: @highlight.image, title: @highlight.title }
    assert_redirected_to highlight_path(assigns(:highlight))
  end
